...
The adapter generates a self-signed certificate when the first secure connection attempt is made. Certificate store where its own certificates, and those of the server, will be stored is common for the service instance.
