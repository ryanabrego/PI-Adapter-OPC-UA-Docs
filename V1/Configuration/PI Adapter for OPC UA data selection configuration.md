...
| **DataFilterID** | Optional | `string` | Enables data filtering for this data selection item, when specified. If value is not specified or set to null, all read values are output without filtering.
