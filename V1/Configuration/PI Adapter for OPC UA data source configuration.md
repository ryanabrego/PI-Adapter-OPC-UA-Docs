...
| **DefaultStreamIdPattern** | Optional | `string` | Specifies the default stream Id pattern to use. Possible parameters: {NamespaceIndex}, {Identifier}, {Name}. <br><br>Allowed value: any string<br>Default value: `{NamespaceIndex.Identifier}` |
