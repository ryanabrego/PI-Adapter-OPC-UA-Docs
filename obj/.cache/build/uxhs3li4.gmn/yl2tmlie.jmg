...
<li sourcefile="V1/main/V1/Configuration/System and adapter configuration.md" sourcestartlinenumber="13" sourceendlinenumber="15"><p sourcefile="V1/main/V1/Configuration/System and adapter configuration.md" sourcestartlinenumber="13" sourceendlinenumber="13">Using any text editor, create a file that contains the System and adapter configuration in the JSON format.</p>
...
<p sourcefile="V1/main/V1/Configuration/System and adapter configuration.md" sourcestartlinenumber="37" sourceendlinenumber="37"><strong>Note</strong>: The following is an example configuration, it does not necessarily represent the configuration of the adapter that you are currently using. The data source and data selection configurations are different for every adapter.</p>
<details>
...
<h2 id="rest-urls" sourcefile="V1/main/V1/Configuration/System and adapter configuration.md" sourcestartlinenumber="120" sourceendlinenumber="120">REST URLs</h2>
<table sourcefile="V1/main/V1/Configuration/System and adapter configuration.md" sourcestartlinenumber="122" sourceendlinenumber="124">
<thead>
<tr>
<th>Relative URL</th>
<th>HTTP verb</th>
