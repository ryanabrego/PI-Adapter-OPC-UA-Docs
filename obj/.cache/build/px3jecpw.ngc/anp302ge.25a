...
<p sourcefile="V1/main/V1/Administration/Delete an adapter component.md" sourcestartlinenumber="9" sourceendlinenumber="9">Complete the following steps to delete an adapter component:</p>
...
<p sourcefile="V1/main/V1/Administration/Delete an adapter component.md" sourcestartlinenumber="29" sourceendlinenumber="29">Configuration files are moved to the following location:</p>
...
<p sourcefile="V1/main/V1/Administration/Delete an adapter component.md" sourcestartlinenumber="35" sourceendlinenumber="35">Log files are moved to the following location:</p>
