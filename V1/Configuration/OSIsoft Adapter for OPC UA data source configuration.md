...
| **DefaultStreamIdPattern** | Optional | `string` | Specifies the default stream Id pattern to use. Possible parameters: {NodeId}, {BrowesablePath}, {NewGuid}. Null value will default to {NodeId}. |
...
```json
{
    ...
    "StreamIdPrefix": null,
    "DefaultStreamIdPattern": "{NodeId}.{BrowesablePath}"
}
```
