...
<li sourcefile="V1/main/V1/Configuration/Health endpoint configuration.md" sourcestartlinenumber="14" sourceendlinenumber="16">Using any text editor, create a file that contains one or more health endpoints in JSON form.<ul sourcefile="V1/main/V1/Configuration/Health endpoint configuration.md" sourcestartlinenumber="15" sourceendlinenumber="16">
